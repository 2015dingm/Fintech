...
col = [ tanh_16_2_linear, tanh_16_2_relu, tanh_16_4_2_linear, tanh_16_4_2_relu, tanh_16_8_4_2_linear, tanh_16_8_4_2_relu]
# =============================================================================
# Read data
# =============================================================================
...
filename = 'asset{}_{}'.format(asset_i, test_year)

ret_sub=ret[ret['ID']==asset_i]
# -1, -2, ....., -60
# -1
...
if __name__ == '__main__':
    print(os.getcwd())
    Y_pred_df = single_run(test_year, feature.values, ret_sub['ExRet_f1'].values, filename)
    print(os.getcwd())
